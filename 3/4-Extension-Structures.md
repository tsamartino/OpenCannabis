...
- [8/OCS-X](../9/README.md) / `proximity`: Bluetooth and GPS-related structures.
- [9/OCS-O](../10/README.md) / `oauth`: OAuth2 implementation structures.
- [10/OCS-A](../11/README.md) / `accounting`: Bookkeeping, accounting, taxes, and so on.
